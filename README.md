...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-rfdweng.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-rfdweng.containers.anotherwebservice.com/
...
```
git clone git@github.com:nominmethdam0-ctrl/container-rfdweng.git
cd container-rfdweng
```
...
```
docker attach container-rfdweng
```
